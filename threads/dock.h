...
private:
  ...
  enum dock_state fsm_state_transition(enum dock_state state, const range_t range, float d_desired);
  void fsm_execute(const enum dock_state state, const range_t range, const float dt);
  void fsm_execute2(const enum dock_state state, const range_t range, const float dt);
