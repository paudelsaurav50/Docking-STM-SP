...
#define FSM_D_DOCK_MM 35.0 // Docking enable range
...
#define FSM_LATCH_CURRENT_MILLI_AMP -500 // Current actuation for latching
#define FSM_DISTANCE_PID_SP_MM 40 // Distance setpoint bias
